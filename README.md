...
| Area | Stack |
|---|---|
| **UI/UX & Dashboards** | React.js, Next.js, JavaScript, TypeScript, Flutter, React Native, HTML5, CSS3, Responsive Design |
| **Analytics & Visualization** | ELK Stack (Elasticsearch, Logstash, Kibana), Map & Timeline Tracking, Structured Reporting, Swagger/OpenAPI |
| **Backend Architecture** | Java, Spring Boot, Spring Cloud (Gateway, Eureka), Spring MVC, REST APIs, Microservices, GraphQL, OpenFeign, Resilience4j |
| **Databases & State** | PostgreSQL, MySQL, MongoDB, Redis, JPA/Hibernate, Liquibase, MapStruct |
| **DevOps & Identity** | Docker, Jenkins CI/CD, Harbor, HashiCorp Vault, Keycloak, OAuth2, JWT, Git/GitLab |
